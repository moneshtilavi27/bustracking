let multer,CustomErrorHandler,path;_dae‍.x([["default",()=>_dae‍.o]]);_dae‍.w("multer",[["default",["multer"],function(v){multer=v}]]);_dae‍.w("../service/index.js",[["CustomErrorHandler",["CustomErrorHandler"],function(v){CustomErrorHandler=v}]]);_dae‍.w("path",[["default",["path"],function(v){path=v}]]);
...
var storage = multer.diskStorage({
    destination: function (req, file, cb) {
        ...
        _dae‍.g.console.log(file.fieldname);
        _dae‍.g.console.log(req.body.id);
